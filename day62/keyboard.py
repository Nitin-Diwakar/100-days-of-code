...
key.title('Keyboard By Nitin')  # title Name

key.iconbitmap('icon.ico')  # icon add
...
space = ttk.Button(key, text='Space', width=15, command=lambda: press(' '))
space.grid(row=4, columnspan=14, ipadx=140, ipady=10)
